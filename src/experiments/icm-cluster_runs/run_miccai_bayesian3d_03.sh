...
--latent_dimension__s 32 --latent_dimension__a 64 --kernel_width__s 5 --kernel_width__a 2 \
--lambda_square__s 10. --lambda_square__a 10. --noise_variance 0.0025 --dropout .1 \
