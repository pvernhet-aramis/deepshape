...
#--epochs 1000 --batch_size 32 --nb_train 10000 --nb_test 124 --num_workers 0 \
#--optimizer "Adam" --accumulate_grad_batch 2 --lr .0005 --step_lr 50 --update_every_batch 128 --update_from_epoch 100 \
...
--lambda_square__s 0.01 --lambda_square__a 0.25 --noise_variance 0.0025 \
--epochs 1000 --batch_size 8 --nb_train 330 --nb_test 32 --num_workers 0 \
--optimizer "Adam" --accumulate_grad_batch 4 --lr .0005 --step_lr 250 --update_every_batch 4 --update_from_epoch 250 \
--write_every_epoch 5 --row_log_interval 2 \