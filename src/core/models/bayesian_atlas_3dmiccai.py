...
class VariationalMetamorphicAtlas3dExecuter(pl.LightningModule):

    def __init__(self, hparams):
        super(VariationalMetamorphicAtlas3dExecuter, self).__init__()
        ...
        # ---------- MODEL
        self.model = MetamorphicAtlas3d(intensities_template, self.hparams.number_of_time_points,
...
if __name__ == '__main__':
    ...
    VAE_metamorphic = VariationalMetamorphicAtlas3dExecuter(args)
