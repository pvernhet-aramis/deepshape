...
PYTHON_SCRIPT=${HOME}/${PROJECT_PATH}/${MODELS_PATH}/'autoencoder_atlas_2dmiccai.py'
...
--latent_dimension__a 10 --kernel_width__a 2 \
--lambda_square__a 10. --noise_variance 0.0025 --dropout .2 \
