...
--epochs 1000 --batch_size 32 --nb_train 1000 --nb_test 124 --num_workers 0 \
--optimizer "Adam" --accumulate_grad_batch 2 --lr .001 --step_lr 500 --update_from_epoch 500 \
--write_every_epoch 5 --row_log_interval 2 \


python "${PYTHON_SCRIPT}" --data_dir "${DATADIR}" \
--cuda --num_gpu 1 \
--dataset "mock" --downsampling_data 2 --downsampling_grid 1 --sliced_dim 0 \
--latent_dimension__s 2 --latent_dimension__a 2 --kernel_width__s 10 --kernel_width__a 2 \
--lambda_square__s 0.01 --lambda_square__a 0.25 --noise_variance 0.0025 \
--epochs 1000 --batch_size 32 --nb_train 1000 --nb_test 124 --num_workers 0 \
--optimizer "Adam" --accumulate_grad_batch 2 --lr .001 --step_lr 500 --update_from_epoch 500 \
...
#--lambda_square__s 0.01 --lambda_square__a 0.25 --noise_variance 0.0025 \
#--epochs 1000 --batch_size 32 --nb_train 1000 --nb_test 124 --num_workers 0 \
#--optimizer "Adam" --accumulate_grad_batch 2 --lr .0001 --step_lr 500 --update_from_epoch 500 \
#--write_every_epoch 5 --row_log_interval 2 \
#
#
#python "${PYTHON_SCRIPT}" --data_dir "${DATADIR}" \
...
#--lambda_square__s 0.01 --lambda_square__a 0.25 --noise_variance 0.0025 \
#--epochs 1000 --batch_size 32 --nb_train 1000 --nb_test 124 --num_workers 0 \
#--optimizer "Adam" --accumulate_grad_batch 2 --lr .0001 --step_lr 1000 --update_from_epoch 500 \
#--write_every_epoch 5 --row_log_interval 2 \
