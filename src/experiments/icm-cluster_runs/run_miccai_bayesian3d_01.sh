...
#export PATH="/network/lustre/dtlake01/aramis/users/paul.vernhet/anaconda3/bin:$PATH"
#conda init bash
...
--latent_dimension__s 10 --latent_dimension__a 10 --kernel_width__s 2.5 --kernel_width__a 2 \
...
--optimizer "Adam" --accumulate_grad_batch 8 --lr .0005 --step_lr 4000 --update_from_epoch -1 \
--checkpoint_period 2 --write_every_epoch 5 --row_log_interval 2 --which_print "both" \
